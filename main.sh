...
if [[ $USER_ENV == "true" ]]; then
    ...
    generate_md results/${TIME_STAMP}/customer/results results/${TIME_STAMP}/customer/report.md $TEST_SNAPSHOT "Regression" "user" $_acm_version $_acm_console $_spoke_cluster_version $_spoke_cluster_name
    ...
    do
        ...
        source utils/gen_report.sh
        generate_md results/${TIME_STAMP}/${type}_${ACM_VERSION}/results results/${TIME_STAMP}/${type}_${ACM_VERSION}/report.md $TEST_SNAPSHOT "Regression" $type $_acm_version $_acm_console $_spoke_cluster_version $_spoke_cluster_name
        push_report results/${TIME_STAMP}
    done
fi
